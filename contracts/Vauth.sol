...
contract Vauth {
    address owner;
    // string temp;
    // function Vauth(string _temp) public {
    //     temp = _temp;
    // }
    ...
    */
    ...
    function getNotOwnedCodeDetails(string memory _code)
        public
        view
        returns (
            string memory,
    ...
    function getOwnedCodeDetails(string memory _code)
        public
        view
    ...
    function getCustomerDetails(string memory _code)
        public
        view
        returns (string memory, string memory)
    {
    ...
    function getRetailerDetails(string memory _code)
        public
        view
        returns (string memory, string memory)
    {
    ...
    function reportStolen(string memory _code, string memory _customer)
        public
        payable
        returns (bool)
    {
